...
def main(model_args, data_args, training_args, custom_args):
    ...
    train_dataset, eval_dataset = create_datasets(
        tokenizer,
        data_args,
        apply_chat_template=tokenizer.chat_template,
    )
    if custom_args:
    ...
    trainer.save_model()
    # trainer.save_model(f'/home/hyt/ei_llm/models/openseek-2002')
...
if __name__ == "__main__":
    ...
    main(model_args, data_args, training_args, custom_args)
